...
targets=[]
targets.append(Target(colour=Colours.BLACK,location=Coordinate(x=4,y=2.1,z=4)))
targets.append(Target(colour=Colours.BLUE,location=Coordinate(x=6.7,y=2.1,z=8)))
targets.append(Target(colour=Colours.RED,location=Coordinate(x=2,y=2,z=6)))
targets.append(Target(colour=Colours.YELLOW,location=Coordinate(x=7.3,y=-2,z=6)))
targets.append(Target(colour=Colours.YELLOW,location=Coordinate(x=7.3,y=0,z=6)))
targets.append(Target(colour=Colours.RED,location=Coordinate(x=5,y=-2,z=6)))
#floor targets
...
MappedTarget=target_rel_position.locate_targets(planes=planes,targets=targets,first_direction=Direction.WEST)
